...
| Modelo | AUPRC | Recall | Precision | F1-Score | Falsos Positivos | Falsos Negativos | 
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| Regressão Logística (Baseline) | 0.6955 | 0.5789 | 0.8462 | 0.6875 | 10 | 40 | 
| Random Forest | 0.7805 | 0.7474 | 0.8875 | 0.8114 | 9 | 24 |
| *XGBoost (base)* | *0.8251* | *0.7895* | *0.9375* | *0.8571* | *5* | *20* |
| XGBoost + SMOTE | 0.8044 | 0.7684 | 0.8690 | 0.8156 | 11 | 22 | 
| XGBoost Tuned (RandomizedSearchCV) | 0.7936 | 0.8316 | 0.4489 | 0.5830 | 97 | 16 | 
